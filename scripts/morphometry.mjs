...
export const REFERENCES = {
  honeybee:     { headR: 0.245, thoraxR: 0.23, abdomenR: 0.525, heightR: 0.29, eyeR: 0.5, wingR: 0.68, legR: 0.66, antR: 0.32, src: 'Apis — region splits + eye from labelled reference model (scripts/comparator.mjs), rest measured' },
